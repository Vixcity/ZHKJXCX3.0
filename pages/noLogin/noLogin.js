...
Page({
  ...
  canToManage() {
    if (
      ...
      wx.getStorageSync("userInfo").userinfo !== null
    ) {
      this.toManage();
    }
  },
                  ...
                  wxReq({
                    ...
                    if (res.data.data === "未注册，请注册") {
                      ...
                      if (_this.data.order) {
                        wx.navigateTo({
                          url:
                            "../signUp/signUp?isLeader=true&order=" +
                            _this.data.order,
                        });
                        return;
                      }
                      ...
                      if (_this.data.order) {
                        wx.navigateTo({
                          url:
                            "../orderControl/orderControl?isLeader=true&order=" +
                            _this.data.order,
                        });
                        return;
                      }
                      ...
                      if (_this.data.showPopup) {
                        wx.navigateTo({
                          url:
                            "../workerManage/workerManage?showPopup=" +
                            _this.data.showPopup,
                        });
                        return;
                      }
